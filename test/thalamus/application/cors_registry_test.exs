defmodule Thalamus.CORSRegistryTest do
  ...
  describe "rebuild_from_clients/0" do
    test "carga orígenes únicamente desde clientes activos y extrae bien el host" do
      ...
      org_changeset = OrganizationSchema.create_changeset(%{
        "name" => "Org Test CORS",
        "plan_type" => :standard,
      ...
      client_changeset = OAuth2ClientSchema.create_changeset(%{
        ...
        "redirect_uris" => [
          ...
          "invalid-uri" # Esto prueba el bloque `rescue` de `extract_origin/1`
        ]
      })
