...
if config_env() == :prod do
  ...
  public_port = if public_port > 0, do: public_port, else: (if System.get_env("FORCE_SSL") == "true", do: 443, else: 80)
  ...
  config :thalamus, :host, host
  config :thalamus, :public_port, public_port
